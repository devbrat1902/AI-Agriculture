...
async function getCoordinates() {
  ...
  // Delhi: { lat: 28.6139, lon: 77.2090, city: "Delhi, India" }
  // Mumbai: { lat: 19.0760, lon: 72.8777, city: "Mumbai, India" }
  // Bangalore: { lat: 12.9716, lon: 77.5946, city: "Bangalore, India" }
  // Pune: { lat: 18.5204, lon: 73.8567, city: "Pune, India" }
  // Chennai: { lat: 13.0827, lon: 80.2707, city: "Chennai, India" }
  // Hyderabad: { lat: 17.3850, lon: 78.4867, city: "Hyderabad, India" }
  // Kolkata: { lat: 22.5726, lon: 88.3639, city: "Kolkata, India" }
